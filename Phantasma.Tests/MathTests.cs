...
namespace Phantasma.Tests
{
    ...
    public class MathTests
    {
        ...
        public void TestToString()
        {
            ...
            Assert.IsTrue(x.ToHex() == "");
        }
        ...
        {
            string target10 =
                "15987359817890231750789698749123458976230589720895710384562385638956120587125608713560178943630781423870463018945601847634098571309456031457609187590238750165091345781387520398";
            string target16 =
                "40A3C28C78BB55D1610C882176411DC1D7D3121CE1A25711F85FC35C34C6A3FD2BC2F0C2C7401C15A11EFA5B41D0C5E7617DB9B4B99965EC5851C13D88A1ACE6566D9B7D3F4D89698E";

            var test10 = new BigInteger(target10, 10);
            var test16 = new BigInteger(target16, 16);

            Assert.IsTrue(test10.ToDecimal() == target10);
            Assert.IsTrue(test16.ToHex() == target16);
        }
        ...
        public void TestModPow()
        {
            ...
            /*
            result = BigInteger.ModPow(b, -exp, mod);
            target = new BigInteger("? dont know, need to find out first");
            Assert.IsTrue(result == target);
            */
        }
